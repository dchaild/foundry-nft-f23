...
contract MoodNftTest is Test {
    ...
    function setUp() public {
        ...
        // Get the raw SVG strings from the deployment script
        ...
        // Use the deployer's helper function to generate the URIs
        string memory happySvgImageUri = deployer.svgToImageUri(happySvg);
    ...
    function testMintNft() public {
        vm.prank(USER);
        moodNft.mintNft();
        string memory tokenUri = moodNft.tokenURI(moodNft.getTokenCounter() - 1);
    ...
    function testViewTokenUri() public {
        vm.prank(USER);
        moodNft.mintNft();
        uint256 newTokenId = moodNft.getTokenCounter() - 1;
        console.log("Token URI:", moodNft.tokenURI(newTokenId));
